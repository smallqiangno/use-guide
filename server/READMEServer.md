...
### 额外步骤2：安装BBR加速工具,BBR是谷歌出品的TCP拥塞控制算法，有人专门测试过，安装后网速会提升数倍，魔改版的BBR甚至能到几十倍(这个感觉有点夸张了)
[安装BBR教程](https://github.com/smallqiangno/use-guide/blob/master/BBR/READMEBBR.md)
